<section id='content_secretaria'>
    <div>
        <!-- Secção para ver as consultas marcadas-->
        ...
        <?php if (isset($_SESSION['consultas_doutor']) && !empty($_SESSION['consultas_doutor'])) { ?>
            ...
            <!-- Secção para mostrar os dados das consultas marcadas-->
            ...
            <fieldset class="schedule-form">
                ...
                <?php } else { ?>
                    ...
                    <?php if (!$_SESSION['report_empty']) { ?>         <!-- Usou-se uma flag para ver se o campo de mostrar o relatório está selecionado-->
                        <h2>Relatório Escrito</h2>
                        <div class="report-container">
                            <p><?php echo $_SESSION['report_written']; ?></p>   <!-- Mostra o relatório-->
                        </div>
                    <?php } ?>
