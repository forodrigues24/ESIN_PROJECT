<section id='content_profile'>
    <div>
        ...
        <!-- Secção que mostra os dados da pessoa -->
        ...
        <!-- Mostra as consultas marcadas caso a pessoa tenha alguma consulta associada ao seu nome -->
        ...
        <fieldset class="perfil">
            ...
            ?>
                ...
                <?php } ?>
            <?php }
            // Caso a pessoa seja um employee, mostra também o seu horário de trabalho

            if (($_SESSION['role_user'] !== 'patient')) { ?>
                <h2>Horário</h2>
